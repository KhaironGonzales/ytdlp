...
import subprocess
import platform
import ctypes  # Needed for Windows taskbar icon fix
...
if sys.platform == "win32":
    try:
        # Set AppUserModelID to prevent feather icon
        myappid = 'com.khairon.ytdownloader.1.0'
        ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(myappid)
    except Exception as e:
        print(f"Windows AppUserModelID error: {e}")

# Set window icon with proper resource handling
try:
